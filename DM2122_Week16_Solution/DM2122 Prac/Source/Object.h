...
public:
	...
	void init(float translateX, float translateY, float translateZ, float scaleX, float scaleY, float scaleZ, float rotationAmt, float rotateXaxis, float rotateYaxis, float rotateZaxis);
	...
	void setLastTranslationXYZ(float x, float y, float z);
