...
{
public:
	static Mesh* GenerateBoundingBox(const std::string& meshName, Vector3 vertices[8]);
	static Mesh* GenerateAxes(const std::string& meshName, float lengthX, float lengthY, float lengthZ);
	static Mesh* GenerateQuad(const std::string& meshName, Color color, float lengthX, float lengthY, float offsetX, float offsetY, float offsetZ);
	...
	static Mesh* GenerateSphere(const std::string& meshName, Color color, unsigned numStack, unsigned numSlice, float radius, float offsetX, float offsetY, float offsetZ);
